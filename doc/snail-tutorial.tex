...
With help of anchor points, you can position a node by relative displacement with the snail syntax \boxquote{\type{put node at a aligned b}}. Example \in[put-at] aligns the anchor point \type{bar.anchors[2][4]} with the anchor point \type{foo.anchors[2][8]}.
...
put empty at foo.anchors[2][2] aligned empty.anchors[2][6];
