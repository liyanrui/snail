...
With help of anchor points, you can position a node by relative displacement with the snail syntax \boxquote{\type{put node at a based b}}. Example \in[put-at] aligns the anchor point \type{bar.anchors[2][4]} with the anchor point \type{foo.anchors[2][8]}.
...
The snail module provides the \type{annotate} macro for labeling paths. This macro put some text based the middle point of a path.
