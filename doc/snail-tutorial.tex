...
The label of \type{p2} appears distorted because its center is aligned with the bend in \type{p2}. If you want to correct it, you need to use the \type{snap} macro which can take a part of a path as the labeling target instead of the origin path.
...
def mind(expr a, content) =
  begingroup
    ...
    startsnailway; draw p; stopsnailway;
    annotate(snap(p, t, 1), content);
  endgroup
enddef;
\stopMP
\startMP
