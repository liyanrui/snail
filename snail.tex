...
\startMPinclusions[+]
numeric 竖亥.直径;
path 竖亥.圆, 竖亥.前路, 竖亥.后路, 竖亥.侧前路, 竖亥.侧后路, 竖亥.新路;
pair 竖亥.前点, 竖亥.后点, 竖亥.跃点, 竖亥.走向, 竖亥.偏向;
tertiarydef a 越过 b =
  hide(竖亥 := a intersectionpoint b;
       竖亥.直径 := 获 "蜗界.字号";
       竖亥.圆 := fullcircle scaled 竖亥.直径 偏 竖亥;
       竖亥.前路 := a cutafter b cutafter 竖亥.圆;
       竖亥.后路 := a cutbefore b cutbefore 竖亥.圆;
       竖亥.前点 := point 1 along 竖亥.前路;
       竖亥.后点 := point 0 along 竖亥.后路;
       竖亥.走向 := unitvector(竖亥.后点 - 竖亥.前点);
       竖亥.侧前路 := b cutafter a cutafter 竖亥.圆;
       竖亥.侧后路 := b cutbefore a cutbefore 竖亥.圆;
       竖亥.偏向 := unitvector((point 0 along 竖亥.侧后路) - (point 1 along 竖亥.侧前路));
       if ((竖亥.走向 rotated 90) dotprod 竖亥.偏向) < 0:
         竖亥.走向 := 竖亥.走向 rotated -90;
       else:
         竖亥.走向 := 竖亥.走向 rotated 90;
       fi;
       竖亥.跃点 := .5[竖亥.前点, 竖亥.后点] 偏 (.5竖亥.直径 * 竖亥.走向);
       竖亥.新路 := 竖亥.前路 .. 竖亥.跃点 .. 竖亥.后路;)
    竖亥.新路
enddef;
\stopMPinclusions
