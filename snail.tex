...
\startMPinclusions[+]
numeric 竖亥直径;
path 竖亥圆, 竖亥前路, 竖亥后路, 竖亥路;
pair 竖亥前点, 竖亥后点, 竖亥跃点;
tertiarydef a 越过 b =
  hide(竖亥 := a intersectionpoint b;
       竖亥直径 := 获 "蜗界.字号";
       竖亥圆 := fullcircle scaled 竖亥直径 偏 竖亥;
       竖亥前路 := a cutafter b cutafter 竖亥圆;
       竖亥后路 := a cutbefore b cutbefore 竖亥圆;
       竖亥前点 := point 1 along 竖亥前路;
       竖亥后点 := point 0 along 竖亥后路;
       竖亥跃点 := .5[竖亥前点, 竖亥后点] 
                 偏 (.5竖亥直径 * (unitvector(竖亥后点 - 竖亥前点) rotated 90));
       竖亥路 := 竖亥前路 .. 竖亥跃点 .. 竖亥后路;)
    竖亥路
enddef;
\stopMPinclusions
